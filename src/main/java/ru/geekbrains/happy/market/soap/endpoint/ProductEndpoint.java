...
import ru.geekbrains.happy.market.soap.GetProductByTitleRequest;
import ru.geekbrains.happy.market.soap.GetProductByTitleResponse;
...
public class ProductEndpoint {
    ...
    public GetProductByTitleResponse getStudentByName(@RequestPayload GetProductByTitleRequest request) {
        ...
        response.setProduct(productService.findByTytle(request.getTitle()));
        return response;
    }
